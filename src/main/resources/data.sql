INSERT INTO contest(id, created_at, updated_at, deleted_at, running_start_date_time, running_end_date_time, auth_code,
                    host_name, name, rate_accuracy_by_scoring, rate_time_by_scoring)
VALUES (0xd45fa47fb1de42b29b5982b6cacb1614, now(), now(), null,
        TIMESTAMPADD(Minute, -30, now()), TIMESTAMPADD(Minute, -15, now()),
        '000000', '00 다문화 센터', '00 다문화 센터 1차 대회/종료된 대회',
        0, 1),
       (0x53A703531F964B3984F922704218627F, now(), now(), null,
        now(), TIMESTAMPADD(Minute, 1000, now()),
        '000001', 'XX 다문화 센터', 'XX 다문화 센터 2차 대회/진행중',
        1, 0),
       (0x992033a011c945b0a64301a2c706f118, now(), now(), null,
        TIMESTAMPADD(Minute, 1000, now()), TIMESTAMPADD(Minute, 2000, now()),
        '000002', '00 다문화 센터', '00 다문화 센터 3차 대회/시작하지 않은 대회',
        0.5, 0.5),
       (0xFFBBABA2E0144CF1A254C5634A68B360, now(), now(), null,
        TIMESTAMPADD(MONTH, 2, now()), TIMESTAMPADD(MONTH, 3, now()),
        '000003', '00 다문화 센터', '00 다문화 센터 4차 대회/2개월뒤 시작', 0.5, 0.5),
       (0x27BEAA0A0DD94B118080871A3AAD4F05, now(), now(), null,
        TIMESTAMPADD(DAY, 1, now()), TIMESTAMPADD(DAY, 2, now()),
        '000004', '00 다문화 센터', '00 다문화 센터 5차 대회/하루 뒤에 시작',
        0.5, 0.5),
       (0xA3030109B69E417A8B18E2D12A3C33DE, now(), now(), null,
        TIMESTAMPADD(DAY, 1, now()), TIMESTAMPADD(DAY, 2, now()),
